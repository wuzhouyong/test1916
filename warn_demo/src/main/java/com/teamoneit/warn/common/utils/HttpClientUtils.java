package com.teamoneit.warn.common.utils;
...
public class HttpClientUtils {
    ...
    public static String sendPost(String url, Map<String, String> headers, String data) throws IOException {
        return doPostByJSON(url, headers, data, ENCODING);
    }
    public static String sendPut(String url, Map<String, String> headers, String data) throws IOException {
        return doPutByJSON(url, headers, data, ENCODING);
    }
    /**
    ...
    private static String doPostByJSON(String url, Map<String, String> headers, String data, String encoding) throws IOException {
        // 请求返回结果
        String resultJson = null;
        // 创建Client
        CloseableHttpClient client = HttpClients.createDefault();
    ...
    private static String doPutByJSON(String url, Map<String, String> headers, String data, String encoding) throws IOException {
        // 请求返回结果
        String resultJson = null;
        // 创建Client
        CloseableHttpClient client = HttpClients.createDefault();
